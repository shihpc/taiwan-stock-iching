...
- ⑧ 的欄恰為 `floor_applied`／`overheat_cap_applied` 兩種且同格同欄無重複列／`floor_applied` 只出現在中期個股／
...
突變實測（首版 9 個＋第二版 7 個＋第三版 4 個＋第四版 17 個＋第五版 2 個，除明列的等價突變外全數被預期的那支測試抓到）：拿掉 ②／⑧／半 marker 三道守門、`**6`→`**5`、
