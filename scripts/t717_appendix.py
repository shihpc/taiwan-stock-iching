...
#: 於裁定 #63（2026-09-23，使用者看過附錄 B 的解讀後同意）確認。值為 None 時附錄標「待使用者確認」，
#: 不得替使用者認定。
CONFIRMED: dict[str, str | None] = {
    "2_hysteresis_flips": "#63",
    "5_trigram_state_diff_rate": "#63",
...
def build(rep: dict[str, Any]) -> str:
    ...
    L = ["## 附錄 B：§16.5 `:717` 門檻行為重驗結果（裁定 #62／#63）", "",
...
def main(argv: list[str] | None = None) -> int:
    ap = argparse.ArgumentParser(description="附錄 B：:717 門檻行為重驗結果（裁定 #62／#63）")
